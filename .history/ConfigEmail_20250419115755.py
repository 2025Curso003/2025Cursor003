class ConfigEmail :
    ...
    def load_config(self):
        ...
        self.config = {
            ...
            ("hbotwnh192@outlook.com", "r2DeF2ETdb"),
            ("zqqlcqkev8318@outlook.com", "e9mozVvbPtlH"),
            ("nqqfxwyolg490@outlook.com", "tkAYhxFDSXR"), 
            ("qmamaemsco886@outlook.com", "wcG687uQakCV"),
            ("oliolbhbp985@outlook.com", "Cp9se1pd17"),

            # ("wjhbbyr5606@outlook.com", "vdzkI3IuRVH"),
            # ("fwqorjylsx8151@outlook.com", "hw0ijwEdcZ"),
            # ("drshpjnq493@outlook.com", "0sxb3JFQQ"),
            # ("hlfwdrro5274@outlook.com", "U7MkDfZZNq"),
            # ("jqggyymqum0341@outlook.com", "Mo9JHfhrM9"),
            
            # ("ptpwcijwe4331@outlook.com", "CdwgNC08OSjR"),
            # ("hrxxwrsf862@outlook.com", "EEY2QaXdnL"),
            # ("fzjmwghy707@outlook.com", "Xz21wr63V"),
            # ("vpczxqj4325@outlook.com", "fc3F3ZccV"),
            # ("wzmwyxlf855@outlook.com", "mlDN9teLm"),
            # ("irxhmpuvq4244@outlook.com", "5HyT3c6kV"),
