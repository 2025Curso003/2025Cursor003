...
class GetVerificationCodeOutLook:
    def __init__(self):
        self.login_url_outlook = "https://go.microsoft.com/fwlink/?linkid=2185828";
        ...
        try:
            ...
            # 使用隐私模式打开新标签页
             ...
             for i in range(5):
                ...
                code_match = re.search(r"Your one-time code is (\d{6})", html_content)
                if code_match:
